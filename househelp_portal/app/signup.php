                        ...
                        <form action="./signup.php" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio">
                                    ...
                                    <label class="custom-control-label" for="maid">Maid</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" class="custom-control-input" id="maid_seeker" name="user_level" value="2">
                                    <label class="custom-control-label" for="maid_seeker">Maid Seeker</label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="form-group">
                                <button type="submit" class="account_btn" name="signup_btn">Signup</button>
                            </div>
                        </form>
