...
function update_profile()
{
    ...
    $sql_update_profile = mysqli_prepare($db_connection, "UPDATE users SET `first_name` = '$first_name', `last_name` = '$last_name', `phone_number` = '$phone', `email_address` = '$email', `residence` = '$residence', `skills` = '$skills' WHERE id = '$id' ");
