...
$db_connection = mysqli_connect("localhost", "root", "", "db_ngong_stage_system");
...
if(isset($_POST["register_user"]))
{
    ...
    $sql_signup_user = mysqli_prepare($db_connection, "INSERT INTO users (`first_name`, `last_name`, `email_address`, `password`) VALUES (?, ?, ?, ?)");
    mysqli_stmt_bind_param($sql_signup_user, "ssss", $first_name, $last_name, $email, $password);
...
if(isset($_POST['update_user_profile']))
{
    ...
    $sql_update_user_profile = mysqli_prepare($db_connection, "UPDATE users SET `first_name` = '$first_name', `last_name` = '$last_name', `email_address` = '$email', `password` = '$password' WHERE id = '$id' ");
...
if(isset($_POST['save_vehicle_details'])){
